...
import { addDownloadFx, $addStatus, addPhaseSet } from '../stores/downloads';
...
export default function Header() {
  ...
  return (
    <header
      className="bg-zinc-800 border-b border-zinc-700 px-4 py-2 flex items-center gap-3 shrink-0 h-12"
      style={{ WebkitAppRegion: 'drag' } as React.CSSProperties}
    >
      {/* Logo */}
      <div
        className="flex items-center gap-1.5 text-emerald-400 font-semibold w-20 shrink-0"
